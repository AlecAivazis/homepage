...
[this project's repo](https://github.com/AlecAivazis/homepage).
...
`Auction` object type requires invoking `itemName.call` on the instance of the auction contract.
...
every auction in our platform! The rest of the stuff in the project is unrelated to this post so we'll
stop here without going over the relay details.
