...
remote services and build a unified abstraction that let's us build our interfaces without worrying about
where the information is coming from. I have used a similar approach to integrate with a popular oauth
provider.
