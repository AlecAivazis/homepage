...
If you have heard of GraphQL before, it's very likely that it was as a query language for a
...
would have almost identical schemas. In our decentralized world, this schema encodes the internal API
between our UI and contracts. This schema and its resolvers can even act as the handoff between separate
teams responsible for blockchain and UI development (if that separation makes sense for you).
