...
If you look in `gateway.go` you'll see that a lot of the necessary boilerplate for creating a gateway instance in already in place. We first have to introspect our remote backends, instantiate the gateway with the results, and wire it up to our http router.
